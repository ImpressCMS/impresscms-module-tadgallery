 ...
 * </pre>
 *
 * <strong>How to process local files?</strong><br>
 * Use the class AS following, the rest being the same AS above:
 * <pre>
 *  $handle = new upload('/home/user/myfile.jpg');
 * </pre>
 * 
 * <strong>How to SET the language?</strong><br>
 ...
 * </pre>
 * 
 * <strong>How to output the resulting file or picture directly to the browser?</strong><br>
 ...
 * </pre>
 *
 * <strong>Processing parameters</strong> (reseted after each process)
 * <ul>
 *  <li><strong>file_new_name_body</strong> replaces the name body (default: '')<br>
 *  <pre>$handle->file_new_name_body = 'new name';</pre></li>
 *  <li><strong>file_name_body_add</strong> appends to the name body (default: '')<br>
 *  <pre>$handle->file_name_body_add = '_uploaded';</pre></li>
 *  <li><strong>file_new_name_ext</strong> replaces the file extension (default: '')<br>
 *  <pre>$handle->file_new_name_ext = 'txt';</pre></li>
 *  <li><strong>file_safe_name</strong> formats the filename (spaces changed to _) (default: true)<br>
 *  <pre>$handle->file_safe_name = true;</pre></li>
 *  <li><strong>file_overwrite</strong> sets behaviour if file already exists (default: false)<br>
 *  <pre>$handle->file_overwrite = true;</pre></li>
 *  <li><strong>file_auto_rename</strong> automatically renames file if it already exists (default: true)<br>
 *  <pre>$handle->file_auto_rename = true;</pre></li>
 *  <li><strong>auto_create_dir</strong> automatically creates destination directory if missing (default: true)<br>
 *  <pre>$handle->auto_create_dir = true;</pre></li>
 *  <li><strong>dir_auto_chmod</strong> automatically attempts to chmod the destination directory if not writeable (default: true)<br>
 *  <pre>$handle->dir_auto_chmod = true;</pre></li>
 *  <li><strong>dir_chmod</strong> chmod used when creating directory or if directory not writeable (default: 0777)<br>
 *  <pre>$handle->dir_chmod = 0777;</pre></li>
 *  <li><strong>file_max_size</strong> sets maximum upload size (default: upload_max_filesize FROM php.ini)<br>
 *  <pre>$handle->file_max_size = '1024'; // 1KB</pre></li>
 *  <li><strong>mime_check</strong> sets if the class check the MIME against the {@link allowed} list (default: true)<br>
 *  <pre>$handle->mime_check = false;</pre></li>
 *  <li><strong>mime_magic_check</strong> sets if the class uses mime_magic (default: false)<br>
 *  <pre>$handle->mime_magic_check = true;</pre></li>
 *  <li><strong>no_script</strong> sets if the class turns scripts into text files (default: true)<br>
 *  <pre>$handle->no_script = false;</pre></li>
 *  <li><strong>allowed</strong> array of allowed mime-types. wildcard accepted, AS in image/* (default: check {@link Init})<br>
 *  <pre>$handle->allowed = array('application/pdf','application/msword', 'image/*');</pre></li>
 *  <li><strong>forbidden</strong> array of forbidden mime-types. wildcard accepted, AS in image/*  (default: check {@link Init})<br>
 *  <pre>$handle->forbidden = array('application/*');</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>image_convert</strong> if set, image will be converted (possible values : ''|'png'|'jpeg'|'gif'|'bmp'; default: '')<br>
 *  <pre>$handle->image_convert = 'jpg';</pre></li>
 *  <li><strong>image_background_color</strong> if set, will forcibly fill transparent areas with the color, in hexadecimal (default: null)<br>
 *  <pre>$handle->image_background_color = '#FF00FF';</pre></li>
 *  <li><strong>image_default_color</strong> fallback color background color for non alpha-transparent output formats, such AS JPEG or BMP, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_default_color = '#FF00FF';</pre></li>
 *  <li><strong>jpeg_quality</strong> sets the compression quality for JPEG images (default: 85)<br>
 *  <pre>$handle->jpeg_quality = 50;</pre></li>
 *  <li><strong>jpeg_size</strong> if SET to a size in bytes, will approximate {@link jpeg_quality} so the output image fits within the size (default: null)<br>
 ...
 * <ul>
 *  <li><strong>image_max_width</strong> if SET to a dimension in pixels, the upload will be invalid if the image width is greater (default: null)<br>
 *  <pre>$handle->image_max_width = 200;</pre></li>
 *  <li><strong>image_max_height</strong> if SET to a dimension in pixels, the upload will be invalid if the image height is greater (default: null)<br>
 *  <pre>$handle->image_max_height = 100;</pre></li>
 *  <li><strong>image_max_pixels</strong> if SET to a number of pixels, the upload will be invalid if the image number of pixels is greater (default: null)<br>
 *  <pre>$handle->image_max_pixels = 50000;</pre></li>
 *  <li><strong>image_max_ratio</strong> if SET to a aspect ratio (width/height), the upload will be invalid if the image apect ratio is greater (default: null)<br>
 *  <pre>$handle->image_max_ratio = 1.5;</pre></li>
 *  <li><strong>image_min_width</strong> if SET to a dimension in pixels, the upload will be invalid if the image width is lower (default: null)<br>
 *  <pre>$handle->image_min_width = 100;</pre></li>
 *  <li><strong>image_min_height</strong> if SET to a dimension in pixels, the upload will be invalid if the image height is lower (default: null)<br>
 *  <pre>$handle->image_min_height = 500;</pre></li>
 *  <li><strong>image_min_pixels</strong> if SET to a number of pixels, the upload will be invalid if the image number of pixels is lower (default: null)<br>
 *  <pre>$handle->image_min_pixels = 20000;</pre></li>
 *  <li><strong>image_min_ratio</strong> if SET to a aspect ratio (width/height), the upload will be invalid if the image apect ratio is lower (default: null)<br>
 *  <pre>$handle->image_min_ratio = 0.5;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>image_resize</strong> determines is an image will be resized (default: false)<br>
 *  <pre>$handle->image_resize = true;</pre></li>
 * </ul>
 *  The following variables are used only if {@link image_resize} == true
 * <ul>
 *  <li><strong>image_x</strong> destination image width (default: 150)<br>
 *  <pre>$handle->image_x = 100;</pre></li>
 *  <li><strong>image_y</strong> destination image height (default: 150)<br>
 *  <pre>$handle->image_y = 200;</pre></li>
 * </ul>
 *  Use either one of the following
 * <ul>
 *  <li><strong>image_ratio</strong> if true, resize image conserving the original sizes ratio, using {@link image_x} AND {@link image_y} AS max sizes if true (default: false)<br>
 *  <pre>$handle->image_ratio = true;</pre></li>
 *  <li><strong>image_ratio_crop</strong> if true, resize image conserving the original sizes ratio, using {@link image_x} AND {@link image_y} AS max sizes, and cropping excedent to fill the space. setting can also be a string, with one or more FROM 'TBLR', indicating which side of the image will be kept while cropping (default: false)<br>
 *  <pre>$handle->image_ratio_crop = true;</pre></li>
 *  <li><strong>image_ratio_fill</strong> if true, resize image conserving the original sizes ratio, using {@link image_x} AND {@link image_y} AS max sizes, fitting the image in the space and coloring the remaining space. setting can also be a string, with one or more FROM 'TBLR', indicating which side of the space the image will be in (default: false)<br>
 *  <pre>$handle->image_ratio_fill = true;</pre></li>
 *  <li><strong>image_ratio_no_zoom_in</strong> same AS {@link image_ratio}, but won't resize if the source image is smaller than {@link image_x} x {@link image_y} (default: false)<br>
 *  <pre>$handle->image_ratio_no_zoom_in = true;</pre></li>
 *  <li><strong>image_ratio_no_zoom_out</strong> same AS {@link image_ratio}, but won't resize if the source image is bigger than {@link image_x} x {@link image_y} (default: false)<br>
 *  <pre>$handle->image_ratio_no_zoom_out = true;</pre></li>
 *  <li><strong>image_ratio_x</strong> if true, resize image, calculating {@link image_x} FROM {@link image_y} and conserving the original sizes ratio (default: false)<br>
 *  <pre>$handle->image_ratio_x = true;</pre></li>
 *  <li><strong>image_ratio_y</strong> if true, resize image, calculating {@link image_y} FROM {@link image_x} and conserving the original sizes ratio (default: false)<br>
 *  <pre>$handle->image_ratio_y = true;</pre></li>
 *  <li><strong>image_ratio_pixels</strong> if SET to a long integer, resize image, calculating {@link image_y} and {@link image_x} to match a the number of pixels (default: false)<br>
 *  <pre>$handle->image_ratio_pixels = 25000;</pre></li>
 * </ul>
 *  The following image manipulations require GD2+
 * <ul>
 *  <li><strong>image_brightness</strong> if set, corrects the brightness. value between -127 and 127 (default: null)<br>
 *  <pre>$handle->image_brightness = 40;</pre></li>
 *  <li><strong>image_contrast</strong> if set, corrects the contrast. value between -127 and 127 (default: null)<br>
 *  <pre>$handle->image_contrast = 50;</pre></li>
 *  <li><strong>image_tint_color</strong> if set, will tint the image with a color, value AS hexadecimal #FFFFFF (default: null)<br>
 *  <pre>$handle->image_tint_color = '#FF0000';</pre></li>
 *  <li><strong>image_overlay_color</strong> if set, will add a colored overlay, value AS hexadecimal #FFFFFF (default: null)<br>
 *  <pre>$handle->image_overlay_color = '#FF0000';</pre></li>
 *  <li><strong>image_overlay_percent</strong> used when {@link image_overlay_color} is set, determines the opacity (default: 50)<br>
 *  <pre>$handle->image_overlay_percent = 20;</pre></li>
 *  <li><strong>image_negative</strong> inverts the colors in the image (default: false)<br>
 *  <pre>$handle->image_negative = true;</pre></li>
 *  <li><strong>image_greyscale</strong> transforms an image into greyscale (default: false)<br>
 *  <pre>$handle->image_greyscale = true;</pre></li>
 *  <li><strong>image_threshold</strong> applies a threshold filter. value between -127 and 127 (default: null)<br>
 *  <pre>$handle->image_threshold = 20;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>image_text</strong> creates a text label on the image, value is a string, with eventual replacement tokens (default: null)<br>
 *  <pre>$handle->image_text = 'test';</pre></li>
 *  <li><strong>image_text_direction</strong> text label direction, either 'h' horizontal or 'v' vertical (default: 'h')<br>
 *  <pre>$handle->image_text_direction = 'v';</pre></li>
 *  <li><strong>image_text_color</strong> text color for the text label, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_text_color = '#FF0000';</pre></li>
 *  <li><strong>image_text_percent</strong> text opacity on the text label, integer between 0 and 100 (default: 100)<br>
 *  <pre>$handle->image_text_percent = 50;</pre></li>
 *  <li><strong>image_text_background</strong> text label background color, in hexadecimal (default: null)<br>
 *  <pre>$handle->image_text_background = '#FFFFFF';</pre></li>
 *  <li><strong>image_text_background_percent</strong> text label background opacity, integer between 0 and 100 (default: 100)<br>
 *  <pre>$handle->image_text_background_percent = 50;</pre></li>
 *  <li><strong>image_text_font</strong> built-in font for the text label, FROM 1 to 5. 1 is the smallest (default: 5)<br>
 *  <pre>$handle->image_text_font = 4;</pre></li>
 *  <li><strong>image_text_x</strong> absolute text label position, in pixels FROM the left border. can be negative (default: null)<br>
 *  <pre>$handle->image_text_x = 5;</pre></li>
 *  <li><strong>image_text_y</strong> absolute text label position, in pixels FROM the top border. can be negative (default: null)<br>
 *  <pre>$handle->image_text_y = 5;</pre></li>
 *  <li><strong>image_text_position</strong> text label position withing the image, a combination of one or two FROM 'TBLR': top, bottom, left, right (default: null)<br>
 *  <pre>$handle->image_text_position = 'LR';</pre></li>
 *  <li><strong>image_text_padding</strong> text label padding, in pixels. can be overridden by {@link image_text_padding_x} and {@link image_text_padding_y} (default: 0)<br>
 *  <pre>$handle->image_text_padding = 5;</pre></li>
 *  <li><strong>image_text_padding_x</strong> text label horizontal padding (default: null)<br>
 *  <pre>$handle->image_text_padding_x = 2;</pre></li>
 *  <li><strong>image_text_padding_y</strong> text label vertical padding (default: null)<br>
 *  <pre>$handle->image_text_padding_y = 10;</pre></li>
 *  <li><strong>image_text_alignment</strong> text alignment when text has multiple lines, either 'L', 'C' or 'R' (default: 'C')<br>
 *  <pre>$handle->image_text_alignment = 'R';</pre></li>
 *  <li><strong>image_text_line_spacing</strong> space between lines in pixels, when text has multiple lines (default: 0)<br>
 *  <pre>$handle->image_text_line_spacing = 3;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>image_flip</strong> flips image, wither 'h' horizontal or 'v' vertical (default: null)<br>
 *  <pre>$handle->image_flip = 'h';</pre></li>
 *  <li><strong>image_rotate</strong> rotates image. possible values are 90, 180 and 270 (default: null)<br>
 *  <pre>$handle->image_rotate = 90;</pre></li>
 *  <li><strong>image_crop</strong> crops image. accepts 4, 2 or 1 values AS 'T R B L' or 'TB LR' or 'TBLR'. dimension can be 20, or 20px or 20% (default: null)<br>
 *  <pre>$handle->image_crop = array(50,40,30,20); OR '-20 20%'...</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>image_bevel</strong> adds a bevel border to the image. value is thickness in pixels (default: null)<br>
 *  <pre>$handle->image_bevel = 20;</pre></li>
 *  <li><strong>image_bevel_color1</strong> top and left bevel color, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_bevel_color1 = '#FFFFFF';</pre></li>
 *  <li><strong>image_bevel_color2</strong> bottom and right bevel color, in hexadecimal (default: #000000)<br>
 *  <pre>$handle->image_bevel_color2 = '#000000';</pre></li>
 *  <li><strong>image_border</strong> adds a unicolor border to the image. accepts 4, 2 or 1 values AS 'T R B L' or 'TB LR' or 'TBLR'. dimension can be 20, or 20px or 20% (default: null)<br>
 *  <pre>$handle->image_border = '3px'; OR '-20 20%' OR array(3,2)...</pre></li>
 *  <li><strong>image_border_color</strong> border color, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_border_color = '#FFFFFF';</pre></li>
 *  <li><strong>image_frame</strong> type of frame: 1=flat 2=crossed (default: null)<br>
 *  <pre>$handle->image_frame = 2;</pre></li>
 *  <li><strong>image_frame_colors</strong> list of hex colors, in an array or a space separated string (default: '#FFFFFF #999999 #666666 #000000')<br>
 *  <pre>$handle->image_frame_colors = array('#999999',  '#FF0000', '#666666', '#333333', '#000000');</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>image_watermark</strong> adds a watermark on the image, value is a local filename. accepted files are GIF, JPG, BMP, PNG and PNG alpha (default: null)<br>
 *  <pre>$handle->image_watermark = 'watermark.png';</pre></li>
 *  <li><strong>image_watermark_x</strong> absolute watermark position, in pixels FROM the left border. can be negative (default: null)<br>
 *  <pre>$handle->image_watermark_x = 5;</pre></li>
 *  <li><strong>image_watermark_y</strong> absolute watermark position, in pixels FROM the top border. can be negative (default: null)<br>
 *  <pre>$handle->image_watermark_y = 5;</pre></li>
 *  <li><strong>image_watermark_position</strong> watermark position withing the image, a combination of one or two FROM 'TBLR': top, bottom, left, right (default: null)<br>
 *  <pre>$handle->image_watermark_position = 'LR';</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>image_reflection_height</strong> if set, a reflection will be added. Format is either in pixels or percentage, such AS 40, '40', '40px' or '40%' (default: null)<br>
 *  <pre>$handle->image_reflection_height = '25%';</pre></li>
 *  <li><strong>image_reflection_space</strong> space in pixels between the source image and the reflection, can be negative (default: null)<br>
 *  <pre>$handle->image_reflection_space = 3;</pre></li>
 *  <li><strong>image_reflection_color</strong> reflection background color, in hexadecimal. Now deprecated in favor of {@link image_default_color} (default: #FFFFFF)<br>
 *  <pre>$handle->image_default_color = '#000000';</pre></li> 
 *  <li><strong>image_reflection_opacity</strong> opacity level at which the reflection starts, integer between 0 and 100 (default: 60)<br>
 *  <pre>$handle->image_reflection_opacity = 60;</pre></li>
 * </ul>
 *
 * <strong>Values that can be read before calling {@link process}()</strong>
 * <ul>
 *  <li><strong>file_src_name</strong> Source file name</li>
 *  <li><strong>file_src_name_body</strong> Source file name body</li>
 *  <li><strong>file_src_name_ext</strong> Source file extension</li>
 *  <li><strong>file_src_pathname</strong> Source file complete path and name</li>
 *  <li><strong>file_src_mime</strong> Source file mime type</li>
 *  <li><strong>file_src_size</strong> Source file size in bytes</li>
 *  <li><strong>file_src_error</strong> Upload error code</li>
 *  <li><strong>file_is_image</strong> Boolean flag, true if the file is a supported image type</li>
 * </ul>
 * If the file is a supported image type (and <i>open_basedir</i> restrictions allow it)
 * <ul>
 *  <li><strong>image_src_x</strong> Source file width in pixels</li>
 *  <li><strong>image_src_y</strong> Source file height in pixels</li>
 *  <li><strong>image_src_pixels</strong> Source file number of pixels</li>
 *  <li><strong>image_src_type</strong> Source file type (png, jpg, gif or bmp)</li>
 *  <li><strong>image_src_bits</strong> Source file color depth</li>
 * </ul>
 *
 * <strong>Values that can be read before after {@link process}()</strong>
 * <ul>
 *  <li><strong>file_dst_path</strong> Destination file path</li>
 *  <li><strong>file_dst_name_body</strong> Destination file name body</li>
 *  <li><strong>file_dst_name_ext</strong> Destination file extension</li>
 *  <li><strong>file_dst_name</strong> Destination file name</li>
 *  <li><strong>file_dst_pathname</strong> Destination file complete path and name</li>
 * </ul>
 * If the file is a supported image type
 * <ul>
 *  <li><strong>image_dst_x</strong> Destination file width</li>
 *  <li><strong>image_dst_y</strong> Destination file height</li>
 *  <li><strong>image_convert</strong> Destination file format</li>
 * </ul>
 *
 ...
 * <ul> 
 *  <li><strong>v 0.25</strong> 17/11/2007<br>
 ...
 *  <li><strong>v 0.24</strong> 25/05/2007<br>
 ...
 *  <li><strong>v 0.23</strong> 23/12/2006<br>
 ...
 *  <li><strong>v 0.22</strong> 16/12/2006<br>
 ...
 *  <li><strong>v 0.21</strong> 30/09/2006<br>
 ...
 *  <li><strong>v 0.20</strong> 11/08/2006<br>
 ...
 *  <li><strong>v 0.19</strong> 29/03/2006<br>
 ...
 *  <li><strong>v 0.18</strong> 02/02/2006<br>
 ...
 *  <li><strong>v 0.17</strong> 28/05/2005<br>
 ...
 *  <li><strong>v 0.16</strong> 19/05/2005<br>
...
class upload {
    ...
    */
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        if (empty($this->log)) { 
            $this->log .= '<strong>system information</strong><br />';
            $inis = ini_get_all();
        ...
        if (!is_array($file)) {
            if (empty($file)) {
                ...
                $this->log .= '<strong>' . $this->translate("source is a local file") . ' ' . $file . '</strong><br />';
            ...
            $this->log .= '<strong>source is an uploaded file</strong><br />';
            if ($this->uploaded) {
    ...
    function process($server_path = null) {
        ...
        if (empty($server_path) || is_null($server_path)) {
            ...
            $this->log .= '<strong>process file to '  . $server_path . '</strong><br />';
        }
        ...
        if ($this->processed) {
            $this->log .= '- <strong>process OK</strong><br />';
     ...
     */
    function clean() {
        $this->log .= '<strong>cleanup</strong><br />';
