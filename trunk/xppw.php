...
if($_GET['op']=="html"){
	...
	$xoopsTpl->assign( "content" , _MD_TADGAL_XPPW_PAGE) ;
...
$cfg = array(
    ...
    'finalurl'          => ICMS_URL."/modules/tadgallery/import.php",
...
//ç¬¬äº­¥é¸“‡ç›®é„ï¼ˆˆ–é¸é …ï¼‰

if ($step == "options")  {
	//ª¢Ÿ¥œ‰ç„¡ç™¼ä½ˆ¬Šé™
	//$p=chk_cate_post_power();
	$p=chk_cate_power("upload");
