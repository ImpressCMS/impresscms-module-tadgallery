...
function tadgallery_carousel_show($options){
	...
	while(list($sn,$title,$description,$filename,$dir)=$xoopsDB->fetchRow($result)){
			...
			$pics.="<li><a href='".ICMS_URL."/modules/tadgallery/view.php?sn={$sn}'><img src='$pic_url' alt='$title' /></a></li>";
	}

	$block="
	<script type='text/javascript' src='".ICMS_URL."/modules/tadgallery/class/jcarousel/lib/jquery.jcarousel.pack.js'></script>
	<link rel='stylesheet' type='text/css' href='".ICMS_URL."/modules/tadgallery/class/jcarousel/lib/jquery.jcarousel.css' />
	<link rel='stylesheet' type='text/css' href='".ICMS_URL."/modules/tadgallery/class/jcarousel/skins/tango/skin.css' />
