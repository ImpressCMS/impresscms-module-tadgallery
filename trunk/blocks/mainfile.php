...
if ( !defined("XOOPS_MAINFILE_INCLUDED") ) {
	...
	// Example: define('ICMS_ROOT_PATH', '/home/ck2/web');
	define('ICMS_ROOT_PATH', '/home/ck2/web');

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define('ICMS_URL', 'http://163.26.52.242/~ck2');
	define('ICMS_URL', 'http://163.26.52.242/~ck2');
	...
	if ( XOOPS_CHECK_PATH && !@ini_get('safe_mode') ) {
		...
		if ( strcasecmp( substr($xoopsScriptPath, 0, strlen(ICMS_ROOT_PATH)), str_replace( DIRECTORY_SEPARATOR, '/', ICMS_ROOT_PATH)) ) {
		 	exit("XOOPS path check: Script is not inside ICMS_ROOT_PATH and cannot run.");
		}
	}
	...
	define('XOOPS_DB_USER', 'ck2');

	// Database Password
	// Password for your database user account
	define('XOOPS_DB_PASS', 'ck222');

	// Database Name
	// The name of database on the host. The installer will attempt to create the database if not exist
	define('XOOPS_DB_NAME', 'ck2');
