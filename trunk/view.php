...
//$div_width=$xoopsModuleConfig['thumbnail_m_width']+30;
	...
	$data="
	$del_js
	<script type='text/javascript' src='".ICMS_URL."/modules/{$MDIR}/class/bubble-tooltip.js'></script>
	<script language='javascript' type='text/javascript' src='".ICMS_URL."/modules/tadgallery/class/copy.js'></script>
	<script type='text/javascript' src='".ICMS_URL."/modules/tadgallery/class/rounded-corners.js'></script>
	<script type='text/javascript' src='".ICMS_URL."/modules/tadgallery/class/form-field-tooltip.js'></script>
	...
	<link rel='stylesheet' type='text/css' media='screen' href='".ICMS_URL."/modules/tadgallery/bubble.css' />
...
<!-- 		<div id='bubble_tooltip'>
	...
	<div style='width:{$div_width}px;margin-left:auto;margin-right:auto;'>
		<dl class='bot_rgt'>
			<dt>
				{$next_btn}&nbsp;{$back_btn}&nbsp;{$path}/{$title}&nbsp;{$copy_pic_url}&nbsp;{$exif_btn}
			</dt>
			<dd>
				<p align='center'>$pic180</p>
				<p style='width:auto;margin-left:auto;margin-right:auto;'>".nl2br($description)."</p>
				<p style='background-color:#AAAAAA;height:20px'>
				<span style='border-top:1px solid #303030;border-left:1px solid #303030;width:auto;float:right;font-size:10px;background-color:#F0F0F0;color:gray;padding:2px 5px 2px 5px;'>$del_btn<strong>{$filename}</strong> ({$size_txt}) {$width} x {$height}</span>
				{$admin_tool}
				</p>
			</dd>
		</dl><!-- /dl -->
